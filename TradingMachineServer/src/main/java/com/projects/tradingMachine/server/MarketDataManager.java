...
public class MarketDataManager implements MessageListener, ServiceLifeCycle {
	...
	public MarketDataManager(final Properties properties) throws JMSException {
		...
		marketDataConsumer =  new TradingMachineMessageConsumer(properties.getProperty("activeMQ.url"), properties.getProperty("activeMQ.marketDataQueue"), DestinationType.Queue, this, "MarketDataManager", null,  null);
	}
