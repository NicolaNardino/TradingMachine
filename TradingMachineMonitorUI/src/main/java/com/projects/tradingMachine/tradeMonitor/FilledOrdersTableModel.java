 ...
 * ExecutedOrdersTopic. 
 * */
public final class FilledOrdersTableModel extends GenericListTableModel<SimpleOrder> {
	private static final long serialVersionUID = 1L;
        
    public FilledOrdersTableModel(final List<SimpleOrder> filledOrders) throws FileNotFoundException, IOException, JMSException {
    	super(filledOrders, new String[] {"ID", "Symbol", "Quantity", "Side", "Type", "Time in Force", "Fill Price", "Limit Price", "Stop Price", "Fill Date", "Market Data ID"});
    }
