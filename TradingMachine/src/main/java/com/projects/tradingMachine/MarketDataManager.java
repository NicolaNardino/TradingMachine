 ...
 * */
public class MarketDataManager implements MessageListener {
	private final ActiveMQConsumerConfiguration activeMQMarketDataConsumerConfiguration;
	...
	public MarketDataManager(final Properties properties) throws JMSException {
		...
		activeMQMarketDataConsumerConfiguration = Utility.createConsumer(properties.getProperty("activeMQ.url"), properties.getProperty("activeMQ.marketDataQueue"), DestinationType.Queue);
		activeMQMarketDataConsumerConfiguration.getConsumer().setMessageListener(this);
	}
	...
	public void closeSubscription() {
		activeMQMarketDataConsumerConfiguration.close();
	}
}
